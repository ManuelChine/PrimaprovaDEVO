    ...
    <html>
      ...
      <body>
        ...
        <form action="/save" method="POST">
          ...
          <button><a style='color:#FFFFFF' href=http://ChinellatoManuelEsameFin-482242865.eu-west-1.elb.amazonaws.com:8080/find>CERCA</a></button>&nbsp;
          <button><a style='color:#FFFFFF' href=http://ChinellatoManuelEsameFin-482242865.eu-west-1.elb.amazonaws.com:8080/list>VISULIZZA TUTTI</a></button>
        </form>
      </body>
    </html>
  `);
...
app.get("/list", async(req, res) => {
    ...
    <html>
      ...
      <h3>Elenco record inseriti</h3>
       ${myresult}
       <button><a style='color:#FFFFFF' href=http://ChinellatoManuelEsameFin-482242865.eu-west-1.elb.amazonaws.com:8080>HOME</a></button>&nbsp;
       <button><a style='color:#FFFFFF' href=http://ChinellatoManuelEsameFin-482242865.eu-west-1.elb.amazonaws.com:8080/find>CERCA</a></button>
...
app.post('/mysearch', async(req, res) => {
    ...
    <html>
      ...
      <h3>RISULTATO DELLA RICERCA per ${enteredText}</h3>
       ${myresult}
      <button><a style='color:#FFFFFF' href=http://ChinellatoManuelEsameFin-482242865.eu-west-1.elb.amazonaws.com:8080/>HOME</a></button>&nbsp;
      <button><a style='color:#FFFFFF' href=http://ChinellatoManuelEsameFin-482242865.eu-west-1.elb.amazonaws.com:8080/find>FAI UN'ALTRA RICERCA</a></button>
      <button><a style='color:#FFFFFF' href=http://ChinellatoManuelEsameFin-482242865.eu-west-1.elb.amazonaws.com:8080/list>VISULIZZA TUTTI</a></button>
